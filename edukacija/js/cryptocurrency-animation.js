/**
 * Cryptocurrency Animation Script
 * Loads and displays the cryptocurrency animation on the tutorial-1.html page
 */

document.addEventListener('DOMContentLoaded', function() {
  // Check if we're on the right page and animation container exists
  const animationContainer = document.getElementById('cryptocurrency-animation');
  ...
  function initAnimation() {
    ...
    player.src = 'Animations/cryptocurrency.json';
